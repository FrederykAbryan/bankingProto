...
const account1 = {
  ...
  movementsDates: [
    ...
    '2021-01-30T10:17:24.185Z',
    '2021-02-03T14:11:59.604Z',
    '2021-02-22T10:01:17.194Z',
...
// const isEven = n => (n % 2 === 0 ? 'Its even number' : 'Its not even number');
// console.log(isEven(8));
// console.log(isEven(25));
// console.log(isEven(677));
...
console.log('ID:  ', new Intl.NumberFormat('id-ID').format(num));
console.log(
  navigator.language,
  new Intl.NumberFormat(navigator.language).format(num)
);

const kapitalF = function (n) {
  return n
    .split(' ')
    .toLowerCase()
...
console.log(kapitalF('fREDERyk abRYAN PalINoan'));
